...
submit.addEventListener("click", async (e) => {
    e.preventDefault(); // prevent the form from submitting if inside a form tag

    if (name.value === "" || email.value === "" || phone.value === "" || final.value != 10) {
        ...
        try {
            ...
            const result = await emailjs.send("service_grjzm79", "template_fq3ecdf", templateParams);
